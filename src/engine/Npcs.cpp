...
: id(id), name(name), age(age), abilities(abilities), summons(summons), mana_elements(mana_elements), rank(rank), level(level), exp_reward(exp_reward), hp(hp), mana(mana), stats({max_hp, max_mana, attack, magic_attack, weapon_attack, defense, magic_defense, weapon_defense, speed, stealth, preception, weapon_user, dual_wield, magic_user, summon_capacity})
{
}
...
: Npc(id, name, age, abilities, summons, mana_elements, rank, level, exp_reward, hp, mana, max_hp, max_mana, attack, magic_attack, weapon_attack, defense, magic_defense, weapon_defense, speed, stealth, preception, weapon_user, dual_wield, magic_user, summon_capacity), bond_level(bond_level)
{
}
